...
- (void)testCreateComment {
    ...
    entity.key = [self testURL:[NSString stringWithFormat:@"%s/comment", sel_getName(_cmd)]];
...
- (void)testCreateCommentJustKey {
    ...
    NSString *entityKey = [self testURL:[NSString stringWithFormat:@"%s/comment", sel_getName(_cmd)]];
    NSNumber *latitude = [NSNumber numberWithFloat:12.f];
    NSNumber *longitude = [NSNumber numberWithFloat:34.f];
...
- (void)testCreateMultipleComments {
    NSString *key1 = [self testURL:[NSString stringWithFormat:@"%s/comment1", sel_getName(_cmd)]];
    NSString *key2 = [self testURL:[NSString stringWithFormat:@"%s/comment2", sel_getName(_cmd)]];
