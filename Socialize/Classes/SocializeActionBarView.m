...
@interface SocializeActionBarView()
...
@implementation SocializeActionBarView
...
//- (void)positionBar {
//    self.frame = CGRectMake(0, self.superview.superview.frame.size.height - ACTION_PANE_HEIGHT, self.superview.superview.frame.size.width,  ACTION_PANE_HEIGHT);
//}
//
//- (void)layoutSubviews {
