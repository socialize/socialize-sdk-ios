...
-(SocializeProfileEditTableViewImageCell *)getProfileImageCell
{
	
	static NSString *profileCellIdentifier = @"profile_Image_cell";
    
	SocializeProfileEditTableViewImageCell *cell =(SocializeProfileEditTableViewImageCell *) [self.tableView dequeueReusableCellWithIdentifier:profileCellIdentifier];
