...
@class SocializeActionBarView;

@protocol SocializeActionBarViewDelegate <NSObject>
...
@interface SocializeActionBarView : UIView {
...
@private
	...
	id<SocializeActionBarViewDelegate>   _socializeDelegate;
}
...
@property (nonatomic, assign) id<SocializeActionBarViewDelegate> delegate;
