...
#define SOCIALIZE_TWITTER_NOT_CONFIGURED_MESSAGE @"Socialize Warning: Twitter is not configured. Facebook UI controls will not be shown. You should consider enabling Socialize's Twitter support, as described in http://socialize.github.com/socialize-sdk-ios/getting_started.html"
