...
{
    UINavigationController * pcNavController = [SZComposeCommentMessageViewController postCommentViewControllerInNavigationControllerWithEntityURL:_entity.key delegate:self];
