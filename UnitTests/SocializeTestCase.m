...
- (void)succeedTwitterPost {
    [[[SZTwitterUtils expect] andDo6:^(id _1, id _2, id _3, id _, id success, id failure) {
        void (^successBlock)(id result) = success;
        successBlock(nil);
    }] postWithViewController:OCMOCK_ANY path:OCMOCK_ANY params:OCMOCK_ANY multipart:NO success:OCMOCK_ANY failure:OCMOCK_ANY];
}
