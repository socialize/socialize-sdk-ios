...
-(void)service:(SocializeService*)service didFetchElements:(NSArray*)dataArray{
    ...
    if ([dataArray count]){
        ...
        if ([object conformsToProtocol:@protocol(SocializeEntity)]){
            ...
            if (!_actionView){
                _actionView = [[SocializeActionBarView alloc] initWithFrame:CGRectMake(0, self.view.bounds.size.height - ACTION_PANE_HEIGHT, self.view.bounds.size.height,  ACTION_PANE_HEIGHT)];
