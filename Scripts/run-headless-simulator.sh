...
# killall "iOS Simulator" >/dev/null 2>&1
...
RUN_CMD="ios-sim launch \"$TEST_TARGET_EXECUTABLE_PATH\" --setenv WRITE_JUNIT_XML=1 --setenv GHUNIT_CLI=1 --setenv GHUNIT_AUTORUN=1 --setenv GHUNIT_AUTOEXIT=1"
